app.factory('curpRfcUtil', function () {

	function calcula(datosPersonales) {
		// console.log('datosPersonales util: ', datosPersonales);

		var ap_materno = 'X';

		var ap_paterno = datosPersonales.ap_paterno;
		var nombre = datosPersonales.nombre;
		var dteNacimiento = datosPersonales.dteNacimiento;
		var sexo = datosPersonales.sexo; //h =  hombre  m= mujer
		var estado = datosPersonales.estado;  //falta validacion de estados

		if(datosPersonales.ap_materno){
			ap_materno = datosPersonales.ap_materno
		}
		
	//  console.log('ap_materno: ', ap_materno);
		...
		var curpGenerated = fnCalculaCURP(nombre_f.toUpperCase(), ap_pat_f.toUpperCase(), ap_mat_f.toUpperCase(), dteNacimiento, sexo, estado);

		// console.log('rfc: ', rfc);
		// console.log('curp: ', curpGenerated);

		var data = {
			rfc: rfc.toUpperCase(),
			curp: curpGenerated.toUpperCase()
		}
		return data;
	}
